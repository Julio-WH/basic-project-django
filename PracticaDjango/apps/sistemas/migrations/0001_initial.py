...
import PracticaDjango.apps.sistemas.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', stdimage.models.StdImageField(default='empresas/logo-blanco.png', force_min_size=False, upload_to=PracticaDjango.apps.sistemas.models.Empresa.logo_path, variations={'thumbnail': {'crop': False, 'height': 50, 'width': 180}})),
                ...
                ('plan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='empresa_plan_empresa', to='sistemas.planempresa')),
            ],
            options={
                'verbose_name': 'Empresa',
                'verbose_name_plural': 'Empresas',
                'permissions': {('ver_perfil_financiero', 'Ver perfil financiero'), ('eliminar_superusuarios', 'Eliminar super usuarios'), ('crear_superusuarios', 'Crear super usuarios'), ('lista_empresas', 'Lista de empresas'), ('acciones_lista_empresas', 'Acciones lista de empresas')},
            },
        ),
    ]
